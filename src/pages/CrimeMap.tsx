    ...
    <div className="flex flex-col gap-4 animate-fade-in" style={{ minHeight: 'calc(100vh - 80px)' }}>
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-2xl font-bold text-white tracking-tight">Crime Intelligence Map</h1>
          </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="flex rounded-xl glass-deep border border-slate-700/40 p-1 gap-1">
          ...
          <select
            ...
            className="rounded-xl glass-deep border border-slate-700/40 px-3 py-2 text-xs text-white outline-none focus:border-blue-500 focus:glow-blue appearance-none cursor-pointer"
          >
          ...
          <select
            ...
            className="rounded-xl glass-deep border border-slate-700/40 px-3 py-2 text-xs text-white outline-none focus:border-blue-500 appearance-none cursor-pointer"
          >
          ...
          <button
            onClick={fetchData}
            className="p-2 rounded-xl glass-deep border border-slate-700/40 text-slate-400 hover:text-blue-400 transition-all btn-press"
          >
      ...
      <div className="relative rounded-2xl overflow-hidden map-frame scanlines" style={{ height: '62vh', minHeight: 380 }}>
                    ...
                    {cl.count === 1 ? (
                      ...
                      <div className="space-y-0.5">
                        {Object.entries(
                          ...
                          <div key={t} className="flex justify-between gap-3 text-xs text-slate-300">
        ...
        <div className="absolute left-4 top-4 z-[1000] flex items-center gap-2 map-overlay rounded-xl px-3 py-2 text-xs font-medium text-slate-200 neon-pulse">
          ...
          <span className="text-slate-600 mx-1">·</span>
          <span className="text-white font-semibold">{filteredHotspots.length}</span>
        ...
        <div className="absolute bottom-4 left-4 z-[1000] map-overlay rounded-xl px-3 py-2.5 text-xs space-y-1.5">
          ...
          <div className="flex items-center gap-2 text-slate-400 border-t border-slate-700/50 pt-1.5 mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-3 glass-deep rounded-2xl border border-slate-700/40 p-4 card-3d">
                ...
                return (
                  <div key={type}>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-xs text-slate-300 truncate max-w-[68%]">{type}</span>
        ...
        <div className="lg:col-span-2 glass-deep rounded-2xl border border-slate-700/40 p-4 card-3d">
          <div className="flex items-center gap-2 mb-4">
            ...
            <div className="space-y-2">
              {filteredHotspots.slice(0, 5).map((hs) => {
                ...
                return (
                  <div
                    key={hs.id}
                    className={`flex items-center gap-2 rounded-xl px-2.5 py-2 transition-all ${isTop ? 'bg-red-500/10 border border-red-500/20' : 'bg-slate-800/40 hover:bg-slate-700/40'}`}
                  >
                    <span className="h-2 w-2 rounded-full shrink-0" style={{ background: col, boxShadow: `0 0 6px ${col}` }} />
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium text-white truncate leading-tight">{hs.area_name}</p>

    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 animate-fade-in-down">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-2 px-4 py-2 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:text-white bg-slate-100 dark:bg-slate-800/60 hover:bg-slate-700/60 border border-slate-200 dark:border-slate-700/50 rounded-xl transition-all btn-press disabled:opacity-50 shadow-sm"
          >
            <RefreshCw className={`w-3.5 h-3.5 ${refreshing ? 'animate-spin' : ''}`} />
            Refresh
          </button>
          <div className="hidden sm:flex text-xs text-slate-500 bg-slate-100/60 dark:bg-slate-800/40 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-700/40">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 items-start">
        <div className="xl:col-span-3 flex flex-col gap-4">
          ...
          <BottomPanels trends={trends} typeDistribution={typeDistribution} topHotspots={topHotspots} predictions={predictions} />
        </div>

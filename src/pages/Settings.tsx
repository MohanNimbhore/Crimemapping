    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center gap-3">
        <div className="p-2 rounded-xl bg-slate-700/60 border border-slate-600/40" style={{ boxShadow: '0 0 16px rgba(148,163,184,0.1)' }}>
          <Palette className="h-5 w-5 text-slate-600 dark:text-slate-300" />
        </div>
        <div>
      ...
      {/* Appearance */}
      <div className="glass-deep rounded-2xl border border-slate-200 dark:border-slate-700/50 card-3d p-5">
      ...
      <div className="glass-deep rounded-2xl border border-slate-200 dark:border-slate-700/50 card-3d p-5">
        ...
        {user ? (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 pt-4 border-t border-slate-200 dark:border-slate-700/50">
              {[
                ...
                <div key={label} className="flex items-center gap-3 rounded-xl bg-white/80 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/40 px-3 py-2.5">
                  {icon}
                  <div>
      ...
      <div className="glass-deep rounded-2xl border border-slate-200 dark:border-slate-700/50 card-3d p-5">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 pt-4 border-t border-slate-200 dark:border-slate-700/50">
            {[
              ...
              <div key={label} className="flex items-start gap-2.5 rounded-xl bg-white/80 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/40 px-3 py-2.5">

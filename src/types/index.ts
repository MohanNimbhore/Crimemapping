...
export interface PatrolRoute {
  ...
  station_name: string;
  hotspots: Array<{ latitude: number; longitude: number; risk_level: string; area_name: string }>;
...
export const CRIME_TYPES = [
  'Theft', 'Robbery', 'Assault', 'Vehicle Theft', 'Cyber Crime',
  'Burglary', 'Vandalism', 'Drug Offense', 'Fraud', 'Harassment',
